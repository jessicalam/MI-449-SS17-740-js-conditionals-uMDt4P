...
'\nIF YOU WANT TO WATCH THE SUNSET TYPE IN 4')
  ...
  } else if (parseFloat(sailingPara) === 2.0 || parseFloat(sailingPara) === 3.0) {
  ...
  } else if (parseFloat(sailingPara) === null || parseFloat(sailingPara) === undefined || parseFloat(sailingPara) > 4.0) {
    window.alert('SOMEHOW YOU TYPED SOMETHING WRONG SO THE MATH THINGY DID NOT WORK. REFRESH THE PAGE.')
  } else {
    window.alert('SOMEHOW YOU TYPED SOMETHING WRONG SO THE MATH THINGY DID NOT WORK. REFRESH THE PAGE.')
  }
} else {
  window.alert('You pressed cancel OR typed something wrong. Refresh the page.')
}
